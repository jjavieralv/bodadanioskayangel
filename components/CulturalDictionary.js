...
export default function CulturalDictionary({ content }) {
  return (
    <div id="frases" data-element-id="bilingual_phrases" className="culture-dictionary">
      ...
      {/* dangerouslySetInnerHTML y no {`...`} como hijo: React escapa " y > al
          generar el HTML, el navegador no los deshace dentro de <style>, y la
          diferencia hacia que React tirase la pagina entera al hidratar. */}
